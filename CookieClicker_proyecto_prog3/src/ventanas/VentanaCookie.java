...
public void mouseEntered(MouseEvent e) {
	...
	num9.getToolTipText();
	num10.setToolTipText("<html>ARCHEMY LAB<br> Tenemos ahora mismo n∫ de shipments.<br> Cookies totales ___ <br></html>");
	num10.getToolTipText();
	num11.setToolTipText("<html>PORTAL<br> Tenemos ahora mismo n∫ de shipments.<br> Cookies totales ___ <br></html>");
	num11.getToolTipText();
	num12.setToolTipText("<html>TIME MACHINE<br> Tenemos ahora mismo n∫ de shipments.<br> Cookies totales ___ <br></html>");
