...
//		lbl_num12.getToolTipText();
		...
		lbl_imagenlogro.setToolTipText("<html>°°°HAS CONSEGUIDO EL LOGRO M¡S DIFICIL Y EXCLUSIVO DE COOKIE CLICKER FELICIDADES!!!<br></html>");
		lbl_imagenlogro.getToolTipText();
		logro.setToolTipText("Si este logro deseas conseguir el nombre m·s sabio deber·s vestir.");
