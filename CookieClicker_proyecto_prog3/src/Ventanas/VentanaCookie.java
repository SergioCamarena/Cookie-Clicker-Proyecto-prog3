...
public void mouseExited(MouseEvent e) {
	...
	public VentanaCookie(){
		...
		//Creacion de ventana
				...
				dias.setHorizontalAlignment(SwingConstants.CENTER);// Estos son para que los numeros estÃ©n centrados en sus labels
			...
			//______VALOR ANYADIDO_______________________________________
				...
				//El JLabel de cookie hay que convertirlo en botÃ³n______________________________FALTA POR HACER
...
/*
 * -Cuando pasas por encima de los botones de los diferentes edificios y demï¿½s te pone todas las cookies 
