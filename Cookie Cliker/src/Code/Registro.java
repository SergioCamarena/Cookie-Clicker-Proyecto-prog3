...
/** Ejercicio MiniPracticaBD con añadidos resueltos:
 * - Búsqueda de nick
 * - Volcar datos a consola 
 * - Cambiar password
...
public class Registro {
	...
	//
	// ¿Es tanto problema si se hace en una búsqueda (select)?
	// ¿Cómo se solucionaría?
	
	private static Logger logger = Logger.getLogger( "Registro" );
